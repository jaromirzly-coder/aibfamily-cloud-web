export default function AIB1Section() {
  return (
    <section className="py-24 bg-fam-950 relative overflow-hidden border-t border-white/[0.06]">
      {/* Subtle glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand-violet/[0.08] rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Label */}
        <span className="inline-block text-xs font-bold text-brand-coral uppercase tracking-[0.2em] mb-5">
          AIB1 Inauguration
        </span>
        ...
        {/* Content block */}
        <div className="glass rounded-2xl p-6 sm:p-8 mb-10 text-left border border-brand-violet/20">
          <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
            ...
            Serial number{" "}
            <span className="font-mono font-bold text-brand-coral">
              AIB-CZ-2026-00001
            </span>
            .
          </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-brand-coral to-brand-violet text-white px-8 py-4 rounded-2xl font-bold text-sm hover:opacity-90 transition-all"
          >
            ▶ Watch Live
          </a>
          <a
